...
html{scroll-padding-top:80px;}
    ...
    const csp = [
      "default-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://fonts.googleapis.com https://fonts.gstatic.com https://picsum.photos https://images.pexels.com https://cdn.pixabay.com https://pixabay.com https://live.staticflickr.com https://upload.wikimedia.org https://openverse.org",
      "img-src * data: blob:",
